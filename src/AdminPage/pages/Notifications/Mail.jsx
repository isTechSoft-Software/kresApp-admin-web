...
import "./notif.css"
import { colors } from "../../color";import EmailIcon from '@mui/icons-material/Email';
    ...
    return (
        <div className="minh100">
            <div className="h-65 border-bottom d-flex justify-content-center align-items-center flex-column">
                <h3 className="mb-2" style={{ color: colors.text.main }}><EmailIcon></EmailIcon> Mail Gönder</h3>
                <textarea onChange={handleChange} className="textarea" value={textValue} cols="80" rows="8" placeholder="Mesajınız"></textarea>
