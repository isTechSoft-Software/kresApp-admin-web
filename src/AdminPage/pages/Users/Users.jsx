...
function Users() {
    ...
    return (
        <div className="users p-5">
            <div className="h-100 w-100 userlists">
                <div className="row h-100">
                    <div className="col-2 p-3 border-end h-100">
                        <div className="mt-5">
                            <button
                    ...
                    <div className="col-10">
                        <div className=" p-3">
                            <div className="aramadiv d-flex align-items-center">
                                <SearchIcon></SearchIcon>
                                <input type="text" onChange={handleSearchChange} value={searchValue} placeholder="Arama" className="aramausers" />
                            </div>
